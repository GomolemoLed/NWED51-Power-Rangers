...
// Handles all login and registration logic for login.html
function initialiseLoginPage() {
  ...
  // Displays a feedback message below the form — red for errors, dark blue for info
...
// Runs on page load — determines the current page and initialises the appropriate functionality
